...
// ==== CONFIGURATION ====
// Replace this with your actual Stripe SECRET key (starts with sk_test_ in sandbox mode)
...
app.post('/api/webhook', express.raw({ type: 'application/json' }), (req, res) => {
  ...
  try {
    // Note: webhook signing secret gets added here once configured in Stripe
